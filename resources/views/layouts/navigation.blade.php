        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user()->role === 1 ? route('admin.dashboard') : route('user.dashboard') }}">
                        <img src="{{ asset('images/family-wallet-logo.png') }}" alt="Family Wallet Logo" class="block h-12 w-auto fill-current text-gray-800" >
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="Auth::user()->role === 1 ? route('admin.profile.edit') : route('user.profile.edit')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="Auth::user()->role === 1 ? route('admin.profile.edit') : route('user.profile.edit')">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
